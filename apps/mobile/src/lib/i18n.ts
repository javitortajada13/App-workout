...
const es = {
  ...
  profile: {
    ...
    spanish: "Espanol",
    english: "English",
    languageError: "No se pudo guardar el idioma. Comprueba tu conexion e intentalo de nuevo.",
...
const en = {
  ...
  profile: {
    ...
    spanish: "Espanol",
    english: "English",
    languageError: "Couldn't save your language. Check your connection and try again.",
    signOut: "Sign out",
  },
